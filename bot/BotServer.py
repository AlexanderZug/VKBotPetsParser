...
class BotServer:
    ...
    def main_photo_content_dogs(self, user_id):  # The method for first page with dogs
    ...
    def __new_message(self):  # The method with some vk-api configurations to get new messages from VK
        for event in self.__longpoll.listen():
            if event.type == VkBotEventType.MESSAGE_NEW:
                msg = event.object.text.upper().translate(self.__char_table)  # for understanding English_keyboard
    ...
    def __photo_from_pages_dogs(self, user_id):  # The method for more-dogs-iteration
